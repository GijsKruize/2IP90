...
/**
 * Dingus -- part of HA Random Artist abstract class representing an arbitrary
 * shape
 * 
 * @author huub
 */
abstract class Dingus {
    /**
     * random generator to be used by all subclasses of Dingus do not change
     */
    ...
    public Dingus(int maxX, int maxY) {
        ...
        //TODO Check if color has been generated already.
